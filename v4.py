...
def extract_blocks_as_images(pdf_path, output_folder, high_quality=True):
    ...
    for page_number in range(len(doc)):
        ...
        if current_question_blocks:
            save_question_image(current_question_blocks, page, zoom, output_folder, page_number, last_question_number, last=True)

    doc.close()

def save_question_image(blocks, page, zoom, output_folder, page_number, question_number, last=False):
...
output_folder = "/Users/tachyon/Downloads/img4"
